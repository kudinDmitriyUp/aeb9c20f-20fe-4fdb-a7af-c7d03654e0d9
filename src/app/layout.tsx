...
export const metadata: Metadata = {
  title: "DefenseVentures | Defense-Focused Venture Capital Fund",
  ...
  keywords: "venture capital, defense sector, defense technology, national security, investment fund",
  metadataBase: new URL("https://defenseventures.com"),
  alternates: {
    canonical: "https://defenseventures.com"
  },
  openGraph: {
    title: "DefenseVentures | Defense-Focused VC Fund",
    description: "Strategic investments in transformative defense technologies and national security innovation.",
    siteName: "DefenseVentures",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766140097263-p4m0u04d.jpg",
        alt: "DefenseVentures - Defense Sector Investment"
      }
    ]
  },
  twitter: {
    ...
    title: "DefenseVentures | Defense-Focused VC Fund",
    description: "Strategic investments in transformative defense technologies.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766140097263-p4m0u04d.jpg"]
  },
  robots: {
    index: true,
    follow: true
